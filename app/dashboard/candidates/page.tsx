...
import { Pencil, Trash2, ChevronLeft, ChevronRight, Check, X } from "lucide-react"
  ...
  if (!candidates.length) {
    return (
      <Card className="w-full border border-gray-200 dark:border-gray-800">
        <CardHeader>
          <CardTitle className="text-gray-900 dark:text-gray-100">All Candidates</CardTitle>
        </CardHeader>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-200 dark:border-gray-800">
                <th className="px-4 py-2 text-left font-medium text-gray-500 dark:text-gray-400">Candidate</th>
            ...
            <tbody>
              {currentCandidates.map((candidate) => (
                <tr key={candidate.id} className="border-b border-gray-200 dark:border-gray-800 last:border-b-0">
